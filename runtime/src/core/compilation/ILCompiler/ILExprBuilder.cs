...
public struct IlExprBuilder {
    ...
    public struct ILLoadExprBuilder
    {
        ...
        public void Arg(int i) => _eb._il.Emit(OpCodes.Ldarg, _eb.InternalMethod.IsStatic ? i : i + 1);

        public void This(bool value = true) {
            _eb._il.Emit(OpCodes.Ldarg_0);
        ...
        public void ValueObject(Type t) => _eb._il.Emit(OpCodes.Ldobj, t);
